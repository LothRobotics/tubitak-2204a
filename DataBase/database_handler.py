...
delete = instance.truncate_collection(collection_name='test', deleted_documents= None)
time.sleep(1)

write = instance.create(collection_name='test', document_name= "BerkerOkan", document_values={'a': 'I <3 Furkan', 'f': 'c'})
write = instance.create(collection_name='test', document_name= "BerkerOkann", document_values={'a': 'I <3 Furkan', 'f': 'c'})
...
# gotten_values = instance.get(collection_name='test', auto_format=True)
>>>>>>> 63466f7131e195bbfc5aefe43adac92e5f6bbc3a
print(delete)