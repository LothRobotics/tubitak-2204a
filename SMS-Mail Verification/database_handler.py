...
class DatabaseHandler():
    ...
    def email_verification(self, sender_email: str, email_password: str, user_email: str):
        ...
        server.sendmail(sender_email, user_email, num)

    def _2factor(self, sender_email: str, email_password, user_email: str):
        ...
        print("2factor start")
        num = str(random.randint(100000, 1000000))
        body_text = "your password is : " + str(num)
        print(body_text)
        server.sendmail(sender_email, user_email, f"The password you will use for login is = {num}")
        print("email sent")
        server.quit

    def get(self, collection_name: str = '', where_clauses: list [str] = [], auto_format: bool = True, general_operator: str = 'and') -> list | dict | bool:
...
sender_email = "tubitak2204A@gmail.com"
email_password = "sysrrsgaigxjhyqw"



db_conn = DatabaseHandler('db_credentials.json')
db_conn._2factor(sender_email, email_password, user_email="tubitak2204A@gmail.com")